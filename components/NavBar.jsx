...
function NavBar() {
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between items-center px-4 md:px-12 lg:flex-row xl:px-68 bg-white text-green-900 py-2 text-center fixed top-0 left-0 right-0 z-10 md:mt-4 md:top-[-20px] font-bold font-mono">
  ...
  >
    ...
    <p className="text-medium md:text-xl lg:text-xl">345 Grays Inn Road, Kings Cross, London, WC1X 8PX</p>
  </div>
  ...
  >
    ...
    <p className="text-medium md:text-xl lg:text-xl">info@kingscrossluggage.co.uk</p>
  </div>
  
  <div className="flex items-center">
  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="24" height="24" viewBox="0 0 256 256" className="w-6 h-6 mr-2">
    <defs></defs>
    <g
      style={{
        stroke: 'none',
  ...
  <p className="text-lg md:text-xl lg:text-xl">075 3354 4428</p>
</div>
 ...
 {/* nav bar */}
<nav className="bg-green-800 w-full fixed top-[90px] md:top-10 left-0 right-0 z-30">
      ...
      <div className="flex items-center justify-between py-3 md:py-5 md:block">
        <Link href="/">
          ...
          <div className="hidden md:flex items-center space-x-6 font-bold">
            <ul className="flex space-x-14 text-white text-2xl">
