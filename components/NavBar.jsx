...
function NavBar() {
  ...
  return (
    <div>
   <div className="flex flex-col md:flex-row justify-between items-justify px-4  bg-white text-green-900 py-3 text-center fixed top-0 left-0 right-0 z-10 md:mt-4 md:top-[-20px] font-bold font-mono">
  {/* Address Section */}
  <div className="flex items-center mb-2 sm:mb-0">
    ...
    <p className="text-xs sm:text-xs md:text-lg lg:text-base xl:text-xl">
